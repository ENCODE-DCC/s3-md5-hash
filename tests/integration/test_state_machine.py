    ...
    * The inserted record will be removed when test completed.
    ...
    def get_and_verify_stack_name(cls) -> str:
        ...
        if not stack_name:
            raise Exception(
                ...
                "Please setup this environment variable with the stack name where we "
    ...
    def setUpClass(cls) -> None:
        ...
        if not state_machine_resources or not transaction_table_resources:
            raise Exception("Cannot find S3MD5HashStateMachine or TransactionTable")
    ...
    def _wait_execution(self, execution_arn: str) -> None:
        while True:
    ...
    def _retrieve_transaction_table_input(self, execution_arn: str) -> Dict[str, Any]:
        """
    ...
    def _verify_transaction_record_written(
        self, transaction_table_input: Dict[str, Any]
    ) -> None:
        """
